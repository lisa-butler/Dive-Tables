...
class HelperMethods(object):
    ...
    def time_calculation(self, user_depth, data):
        ...
        if int(user_depth) > 51:
            print("\n")
            time.sleep(2)
            print('\nBuehlmann tables do not support depths exceeding 51m, please try again\n')
            print("\n")
            time.sleep(2)
        else:
            for row in data:
            ...
            time.sleep(2)
            print("\n------------------------------------------------")               
            print(f'Max time you can stay at {user_depth} meters is: {longest_time} minutes')
            print("------------------------------------------------\n")
            time.sleep(2)
    ...
    def depth_calculation(self, user_time, data):
        ...
        if int(user_time) > 125:
            print("\n")
            time.sleep(2)
            print('\nBuehlmann tables do not support dives exceeding 125 minutes, please try again\n')
            print("\n")
            time.sleep(2)
        else:
            for row in data:
